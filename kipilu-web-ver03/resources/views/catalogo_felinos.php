...
<head>
    ...
    <!--PROPIO-->
    <link rel="stylesheet" href="../css/catalogo_felinos.css">
    <!--LLAMAR ICONOS-->
    ...
    if ($animales) {
        ...
        foreach ($animales as $animal) {
            ...
            if ($animal->Estado_Animal === 3) {
                ...
                echo '<a href="#" class="btn btn-primary btn-sm w-100 mt-2">Formulario de Adopción</a>';
            }
